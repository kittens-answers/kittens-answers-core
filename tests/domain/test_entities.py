...
@pytest.fixture
def created_by():
    return entities.User(id=1, time_stamp=datetime.now(), public_id="id")
...
class TestUser:
    def test_empty_public_id(self):
        with pytest.raises(ValueError, match="public id can not be empty"):
            entities.User(id=1, public_id="", time_stamp=datetime.now())
...
class TestOptions:
    ...
    def test_correct(self, options: frozenset[str], extra_options: frozenset[str]):
        entities.Options(options=options, extra_options=extra_options)
    ...
    def test_incorrect(self, options: frozenset[str], extra_options: frozenset[str]):
...
class TestQuestion:
    ...
    def test_correct(
        ...
        entities.Question(
            ...
            options=entities.Options(options=frozenset(options), extra_options=frozenset(extra_options)),
        )
    ...
    def test_empty_text(self, created_by: entities.User):
        with pytest.raises(ValueError, match="text can not be empty"):
            entities.Question(
                created_by=created_by, id=1, text="", question_type=QuestionType.ONE, options=entities.Options()
            )
    ...
    def test_correct(self, created_by: entities.User):
        entities.QuestionWithAnswer(
            question=entities.Question(
                created_by=created_by, id=1, question_type=QuestionType.ONE, text="?", options=entities.Options()
            ),
        ...
        entities.QuestionWithAnswer(
            question=entities.Question(
                ...
                text="?",
                options=entities.Options(options=frozenset(["1", "2"])),
            ),
            answer=entities.OneAnswer(id=1, value="1"),
        )
...
class TestQuestionWithManyAnswer:
    def test_correct(self, created_by: entities.User):
        entities.QuestionWithAnswer(
            question=entities.Question(
                created_by=created_by, id=1, question_type=QuestionType.MANY, text="?", options=entities.Options()
            ),
...
class TestQuestionWithOrderAnswer:
    def test_correct(self, created_by: entities.User):
        entities.QuestionWithAnswer(
            question=entities.Question(
                created_by=created_by, id=1, question_type=QuestionType.ORDER, text="?", options=entities.Options()
            ),
...
class TestQuestionWithMatchAnswer:
    def test_correct(self, created_by: entities.User):
        entities.QuestionWithAnswer(
            question=entities.Question(
                created_by=created_by, id=1, question_type=QuestionType.MATCH, text="?", options=entities.Options()
            ),
        ...
        entities.QuestionWithAnswer(
            question=entities.Question(
                ...
                text="?",
                options=entities.Options(options=frozenset(["1", "2"]), extra_options=frozenset(["a", "b"])),
            ),
